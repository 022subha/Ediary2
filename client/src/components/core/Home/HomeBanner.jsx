...
export default function HomeBanner() {
  return (
    <div className="bg-[#131110] w-[100vw] h-[100%] pt-16">
      <div className="absolute w-80 h-80 bg-[rgba(255,255,255,0.5)] blur-[100px]"></div>
      <div className="flex flex-wrap justify-around items-center  py-[80px] h-[100%]">
